...
export const smallPetCategories = [
  ...
  { label: 'Bedding', icon: 'bedding' },
]

export const animalTypes = ['Hamster', 'Rabbit', 'Guinea Pig', 'Bird']

export const smallPetBrands = ['Oxbow', 'Kaytee']

export const smallPetProducts = [
  {
    id: 1,
    name: 'Timothy Hay',
...
export const smallPetsFooterLinks = [
  'Privacy Policy',
  'Shipping Info',
  'Return Policy',
  'Contact Us',

...
export const healthProducts = [
  {
    ...
    tag: { label: 'Expert Pick', style: 'bg-[#CFE1E0] text-gray-900' },
  ...
  },
  {
    ...
    tag: { label: 'Vet Approved', style: 'bg-[#64E0D2] text-gray-900' },
  ...
  },
  {
    ...
    tag: { label: 'Essential', style: 'bg-[#64E0D2] text-gray-900' },

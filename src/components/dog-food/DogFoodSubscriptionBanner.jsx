...
export default function DogFoodSubscriptionBanner() {
  return (
    <section className="px-4 pb-14 sm:px-6 lg:px-8">
      <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[2rem] bg-[#64E0D2] p-8 sm:p-10 lg:p-12">
        ...
        <div className="relative z-10 grid items-center gap-8 lg:grid-cols-[1fr_280px]">
          <div>
            <h2 className="text-2xl font-extrabold text-[#52CFC2] sm:text-3xl">
              Never run out of their favorites.
            </h2>
            <p className="mt-3 max-w-xl text-sm leading-relaxed text-[#52CFC2]/90 sm:text-base">
            ...
            >
              ...
              <button
                type="submit"
                className="btn-zoom-hover shrink-0 rounded-full bg-[#52CFC2] px-8 py-3 text-sm font-bold text-white hover:bg-[#52CFC2]"
              >
                Subscribe
              </button>
            </form>

    ...
    <section className="bg-gradient-to-br from-[#FFF0E8] via-[#FDF8F3] to-[#FDF8F3] px-4 pt-8 sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-7xl items-center gap-8 lg:grid-cols-2 lg:gap-12 lg:pb-4">
        <div>
          ...
          <button
            type="button"
            className="btn-zoom-hover mt-8 rounded-full bg-gradient-to-r from-[#D15151] to-[#E56B6B] px-8 py-3.5 text-sm font-bold text-white shadow-md hover:from-[#b84242] hover:to-[#d55a5a]"
          >
            Shop Best Sellers
          </button>
        </div>

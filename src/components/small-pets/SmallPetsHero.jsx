  ...
  return (
    <section className="px-4 pt-6 sm:px-6 lg:px-8">
      <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[2rem] shadow-card">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#374151]/90 via-[#374151]/50 to-transparent" />
        <div className="absolute inset-0 flex items-center px-8 sm:px-12 lg:px-16">
          <div className="max-w-lg">
            <h1 className="text-3xl font-extrabold leading-tight text-white sm:text-4xl lg:text-5xl">
              Little Friends,{' '}
              <span className="inline-flex items-center gap-1.5 text-[#CFE1E0]">
                Big Love
                <PawIcon className="h-5 w-5 text-[#CFE1E0] sm:h-6 sm:w-6" />
                <PawIcon className="-ml-2 h-4 w-4 text-[#CFE1E0]/80 sm:h-5 sm:w-5" />
              </span>
            </h1>
            ...
            <button
              type="button"
              className="btn-zoom-hover mt-8 rounded-full bg-[#64E0D2] px-8 py-3.5 text-sm font-bold text-gray-900 shadow-lg hover:bg-[#64E0D2]"
            >
              Shop All Small Pets
            </button>
          </div>
